...
`skills/` is the canonical source for portable skills. This repository requires Python 3.11+ and PowerShell 7+ (`pwsh`). After every skill edit, run `pwsh -File scripts/sync-skills.ps1` to refresh both runtime copies.
